        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white text-center">
                    <h1 class="h4 mb-0">Editar Historial de Precio</h1>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('product_price_history.update', $productPriceHistory) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="precio_anterior" id="precio_anterior" class="form-control" step="0.01" value="{{ $productPriceHistory->precio_anterior }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="precio_nuevo" id="precio_nuevo" class="form-control" step="0.01" value="{{ $productPriceHistory->precio_nuevo }}" required>
                            @error('precio_nuevo')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
