        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white text-center">
                    <h1 class="h4 mb-0">Editar Ítem de Factura</h1>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('invoice-items.update', $invoiceItem) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="quantity" id="quantity" class="form-control" value="{{ $invoiceItem->quantity }}" required>
                        </div>

                        <!-- Precio -->
                        <div class="mb-4">
                            <label for="price" class="form-label fw-bold">Precio</label>
                            <input type="number" step="0.01" name="price" id="price" class="form-control" value="{{ $invoiceItem->price }}" required>
                        </div>
